...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = redLight_Pin|NIRLight_Pin;
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = blueLight_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(blueLight_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PD12     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = whiteLight_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(whiteLight_GPIO_Port, &GPIO_InitStruct);
