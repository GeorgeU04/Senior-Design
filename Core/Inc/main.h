...
#define RSX_Pin GPIO_PIN_9
#define RSX_GPIO_Port GPIOG
#define CDX_Pin GPIO_PIN_10
#define CDX_GPIO_Port GPIOG
#define CSX_Pin GPIO_PIN_11
#define CSX_GPIO_Port GPIOG
#define WRX_Pin GPIO_PIN_12
#define WRX_GPIO_Port GPIOG
